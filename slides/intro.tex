...
{Sidhant Nagpal, Yathartha Joshi, Shekhar Prasad Rajak, \\ Ravicharan, Jashanpreet Singh}
...
\begin{frame}
  \maketitle
\begin{center}
\normalsize Workshop Content for tutorial is at \url{https://git.io/sympy-pycon-india-18}
\end{center}
\end{frame}
