...
try:
    ...
    if sympy.__version__ < '1.1.1':
        print("SymPy version 1.1.1 or newer is required. You have", sympy.__version__)

    if sympy.__version__ != '1.1.1':
        print("The stable SymPy version 1.1.1 is recommended. You have", sympy.__version__)
